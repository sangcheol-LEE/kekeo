...
const InputChat : React.FC<Props>= ({onClick}) => {
  ...
  return (
    <Base borderColor={theme.colors.gray[100]} backgroundColor={theme.colors.white}>
      <PlusButtonWrapper>
        <PlusButton>
          <BsPlusSquare />
        </PlusButton>
      ...
      <InputWrapper>
        <Input ref={inputRef} onChange={handleChange} borderColor={theme.colors.gray[200]} backgroundColor={theme.colors.gray[100]}/>
      </InputWrapper>

      <SendButtonWrapper>
        <SendButton onClick={handleClick} backgroundColor={theme.colors.primary}>
          <AiOutlineArrowUp />
        </SendButton>
      </SendButtonWrapper>
    </Base>
